...
{  
    ...
    {  
        ...
        {  
            // Gain node already initialized & property already updated/set in selectGainChannel()  
            ...
            {  
                LOG_WARN("Gain property not properly initialized despite selectGainChannel() success.");  
            }  
